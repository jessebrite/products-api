...
class SecretVault:
    ...
    Secrets are loaded from environment variables and can be accessed through this class.
    ...
    def get_optional_secret(self, key: str, default: Optional[str] = None) -> Optional[str]:
